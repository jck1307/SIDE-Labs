...
public abstract class AbstractAmpMojo extends AbstractMojo {
	...
	/**
	 * Returns a string array of the classes and resources to be excluded from
	 * the jar excludes to be used when assembling/copying the AMP.
	 * 
	...
	/**
	 * Returns a string array of the classes and resources to be included from
	 * the jar assembling/copying the war.
	 * 
	...
	/**
	 * Returns a string array of the resources to be included in the AMP web/
	 * folder.
	 * 
	 * @return an array of tokens to include
	 */
	...
	/**
	 * Returns a string array of the resources to be excluded in the AMP web/
	 * folder.
	 * 
	 * @return an array of tokens to exclude
	 */
	 ...
	 * AMPs as an overlay onto this AMP.
	 * 
	 * @return an array of tokens to exclude
	 */
	 ...
	 * AMP as an overlay onto this AMP.
	 * 
	 * @return an array of tokens to include
	 */
	...
	public void buildExplodedAmp(File webappDirectory) throws MojoExecutionException, MojoFailureException {
	 ...
	 * @throws IOException
	 *             if an error occured while copying the files
	 */
	public void buildAmp(MavenProject project, File webappDirectory) throws MojoExecutionException, MojoFailureException, IOException {
		...
		final OverlayManager overlayManager = new OverlayManager(mOverlays, project, dependentAmpIncludes, dependentAmpExcludes);
	 ...
	 * {@link org.alfresco.maven.plugin.amp.packaging.AmpPackagingTask}
	...
	/**
	 * Returns a <tt>List</tt> of the
	 * {@link org.alfresco.maven.plugin.amp.packaging.AmpPostPackagingTask}
	 ...
	 * 
	 * @parameter expression="${maven.amp.moduleProperties}"
	 *            default-value="${project.basedir}/module.properties"
	 */
	...
	/**
	 * Whether the cache should be used to save the status of the webapp accross
	 * multiple runs.
	 * 
	...
	/**
	 * The comma separated list of tokens to include in the AMP internal JAR.
	 * Default **. Default is '**'.
	 * 
	...
	/**
	 * The comma separated list of tokens to exclude from the AMP created JAR
	 * file. By default module configuration is left outside jars.
	 * 
	...
	/**
	 * The comma separated list of tokens to include when doing a AMP overlay.
	 * Default is '**'
	 * 
	 * @parameter
	 */
	...
	private class DefaultAmpPackagingContext implements AmpPackagingContext {
		...
		public DefaultAmpPackagingContext(File webappDirectory, final AmpStructure webappStructure, final OverlayManager overlayManager) {
