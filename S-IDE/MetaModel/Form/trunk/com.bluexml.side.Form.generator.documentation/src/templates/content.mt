   ...
   <text:table-of-content text:style-name="Sect1" text:protected="true" text:name="Table des mati�res1">
    ...
    <text:index-body>
	 ...
	 <text:p text:style-name="P6">
	  <text:a xlink:type="simple" xlink:href="#2.<%getLabel()%> Fields|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link"><%getLabel()%> Fields<text:tab/></text:a>
	  <text:a xlink:type="simple" xlink:href="#2.<%getLabel()%> Fields|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link">1</text:a>
	 </text:p>
