 ...
 * @generated
 */
public class FormWorkflowItemProvider
	 ...
	 * @generated
	 */
	public FormWorkflowItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FormWorkflow_DataForm_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FormWorkflow_DataForm_feature", "_UI_FormWorkflow_type"),
				 FormPackage.Literals.FORM_WORKFLOW__DATA_FORM,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FormWorkflow"));
	}
	...
	public String getText(Object object) {
		String label = ((FormWorkflow)object).getId();
