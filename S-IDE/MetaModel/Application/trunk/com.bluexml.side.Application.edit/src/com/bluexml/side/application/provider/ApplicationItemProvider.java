...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.application.Application} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ApplicationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApplicationPackage.Literals.APPLICATION__ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApplicationPackage.Literals.APPLICATION__ELEMENTS,
				 ApplicationFactory.eINSTANCE.createApplication()));

		newChildDescriptors.add
			(createChildParameter
				(ApplicationPackage.Literals.APPLICATION__ELEMENTS,
				 ApplicationFactory.eINSTANCE.createModel()));

		newChildDescriptors.add
			(createChildParameter
				(ApplicationPackage.Literals.APPLICATION__ELEMENTS,
				 ApplicationFactory.eINSTANCE.createConfiguration()));
	}
