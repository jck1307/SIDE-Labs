...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.requirements.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Entity_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Entity_parent_feature", "_UI_Entity_type"),
				 RequirementsPackage.Literals.ENTITY__PARENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementsPackage.Literals.ENTITY__ATTRIBUTES);
		}
	...
	public String getText(Object object) {
		String label = crop(((Entity)object).getName());
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Entity.class)) {
			case RequirementsPackage.ENTITY__ATTRIBUTES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementsPackage.Literals.ENTITY__ATTRIBUTES,
