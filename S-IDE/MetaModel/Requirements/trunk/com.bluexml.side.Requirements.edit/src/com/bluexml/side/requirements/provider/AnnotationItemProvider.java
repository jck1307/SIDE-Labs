...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.requirements.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_author_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_author_feature", "_UI_Annotation_type"),
				 RequirementsPackage.Literals.ANNOTATION__AUTHOR,
				 false,
				 false,
				 false,
	...
	protected void addDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_date_feature", "_UI_Annotation_type"),
				 RequirementsPackage.Literals.ANNOTATION__DATE,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementsPackage.Literals.ANNOTATION__STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RequirementsPackage.Literals.ANNOTATION__ID,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
