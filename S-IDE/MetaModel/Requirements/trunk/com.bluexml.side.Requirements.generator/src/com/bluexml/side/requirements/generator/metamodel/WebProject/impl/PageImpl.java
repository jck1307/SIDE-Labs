...
public abstract class PageImpl extends EObjectImpl implements Page {
	...
	protected EClass eStaticClass() {
		return WebProjectPackage.Literals.PAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebProjectPackage.PAGE__NAME, oldName, name));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebProjectPackage.PAGE__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebProjectPackage.PAGE__NAME:
				return getName();
