 ...
 * <ul>
 *   <li>{@link com.bluexml.side.requirements.generator.metamodel.WebProject.impl.LoginPageImpl#getLinks <em>Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoginPageImpl extends PageImpl implements LoginPage {
	...
	protected EClass eStaticClass() {
		return WebProjectPackage.Literals.LOGIN_PAGE;
	}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, WebProjectPackage.LOGIN_PAGE__LINKS);
		}
		return links;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebProjectPackage.LOGIN_PAGE__LINKS:
