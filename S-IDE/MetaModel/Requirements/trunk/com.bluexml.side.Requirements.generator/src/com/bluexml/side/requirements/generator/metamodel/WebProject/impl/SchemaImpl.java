 ...
 * <ul>
 *   <li>{@link com.bluexml.side.requirements.generator.metamodel.WebProject.impl.SchemaImpl#getTables <em>Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchemaImpl extends EObjectImpl implements Schema {
	...
	protected EClass eStaticClass() {
		return WebProjectPackage.Literals.SCHEMA;
	}
	...
	public EList<Table> getTables() {
		if (tables == null) {
			tables = new EObjectContainmentEList<Table>(Table.class, this, WebProjectPackage.SCHEMA__TABLES);
		}
		return tables;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WebProjectPackage.SCHEMA__TABLES:
