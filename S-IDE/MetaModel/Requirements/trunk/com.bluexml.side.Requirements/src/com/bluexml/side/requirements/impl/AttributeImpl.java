 ...
 * <ul>
 *   <li>{@link com.bluexml.side.requirements.impl.AttributeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AttributeImpl extends BasicElementImpl implements Attribute {
	/**
	 ...
	 * @ordered
	 */
	protected static final AttributeType TYPE_EDEFAULT = AttributeType.TEXTUAL_VALUE;
	...
	public void setType(AttributeType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.ATTRIBUTE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RequirementsPackage.ATTRIBUTE__TYPE:
				return getType();
		}
