...
public class is_responsiblePreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return ReqDiagramPreferenceConstants.IS_RESPONSIBLE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ReqDiagramPreferenceConstants.IS_RESPONSIBLE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ReqDiagramPreferenceConstants.IS_RESPONSIBLE_EDGE_DEFAULT_ROUTER;
	}
