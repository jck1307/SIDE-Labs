...
public class AgentPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ProDiagramPreferenceConstants.AGENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProDiagramPreferenceConstants.AGENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProDiagramPreferenceConstants.AGENT_DEFAULT_FOREGROUND_COLOR;
	}
