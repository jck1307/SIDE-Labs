 ...
 * @generated
 */
public class GoalPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ReqDiagramPreferenceConstants.GOAL_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ReqDiagramPreferenceConstants.GOAL_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ReqDiagramPreferenceConstants.GOAL_DEFAULT_FOREGROUND_COLOR;
	}
