...
import com.bluexml.side.Requirements.modeler.processDiagram.commands.is_sub_goalEdgeCreationCommand;

/**
 * is_sub_goal edge creation
 *
 * @generated
 */
public class is_sub_goalEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new is_sub_goalEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return ProSimpleObjectConstants.SIMPLE_OBJECT_IS_SUB_GOAL
	...
	protected boolean checkCommand(Command command) {
		return command instanceof is_sub_goalEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Goal
			...
			return new SourceTargetData(false, false, SourceTargetData.NONE,
					null, null, null, null, null, "subgoals", null, null);
		}
		return null;
	}
