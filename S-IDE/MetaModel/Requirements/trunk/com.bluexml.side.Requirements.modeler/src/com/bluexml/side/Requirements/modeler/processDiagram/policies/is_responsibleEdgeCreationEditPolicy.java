...
import com.bluexml.side.Requirements.modeler.processDiagram.commands.is_responsibleEdgeCreationCommand;

/**
 * is_responsible edge creation
 *
 * @generated
 */
public class is_responsibleEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new is_responsibleEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return ProSimpleObjectConstants.SIMPLE_OBJECT_IS_RESPONSIBLE
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof com.bluexml.side.requirements.Agent) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Agent
				&& targetObject instanceof com.bluexml.side.requirements.Goal) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof is_responsibleEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Agent
			...
			return new SourceTargetData(false, false, SourceTargetData.NONE,
					null, null, null, null, null, "isResponsible", null,
					"responsible");
		}
		return null;
	}
