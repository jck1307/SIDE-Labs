...
public class GoalPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ProDiagramPreferenceConstants.GOAL_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProDiagramPreferenceConstants.GOAL_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProDiagramPreferenceConstants.GOAL_DEFAULT_FOREGROUND_COLOR;
	}
