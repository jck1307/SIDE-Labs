 ...
 * @generated
 */
public class AgentPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ReqDiagramPreferenceConstants.AGENT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ReqDiagramPreferenceConstants.AGENT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ReqDiagramPreferenceConstants.AGENT_DEFAULT_FOREGROUND_COLOR;
	}
