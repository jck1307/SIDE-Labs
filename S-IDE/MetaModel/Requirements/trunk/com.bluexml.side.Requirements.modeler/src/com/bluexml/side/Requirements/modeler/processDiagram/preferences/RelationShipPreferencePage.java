...
public class RelationShipPreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return ProDiagramPreferenceConstants.RELATIONSHIP_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProDiagramPreferenceConstants.RELATIONSHIP_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProDiagramPreferenceConstants.RELATIONSHIP_EDGE_DEFAULT_ROUTER;
	}
