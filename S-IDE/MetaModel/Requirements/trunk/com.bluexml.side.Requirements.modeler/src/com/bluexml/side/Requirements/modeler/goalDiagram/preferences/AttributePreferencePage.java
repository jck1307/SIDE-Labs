...
public class AttributePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ReqDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ReqDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ReqDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_FOREGROUND_COLOR;
	}
