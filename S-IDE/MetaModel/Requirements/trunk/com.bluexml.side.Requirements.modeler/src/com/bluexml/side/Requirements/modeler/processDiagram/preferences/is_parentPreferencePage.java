 ...
 * @generated
 */
public class is_parentPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return ProDiagramPreferenceConstants.IS_PARENT_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProDiagramPreferenceConstants.IS_PARENT_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProDiagramPreferenceConstants.IS_PARENT_EDGE_DEFAULT_ROUTER;
	}
