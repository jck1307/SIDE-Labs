 ...
 * @generated
 */
public class GoalStepPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return ProDiagramPreferenceConstants.GOALSTEP_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProDiagramPreferenceConstants.GOALSTEP_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProDiagramPreferenceConstants.GOALSTEP_EDGE_DEFAULT_ROUTER;
	}
