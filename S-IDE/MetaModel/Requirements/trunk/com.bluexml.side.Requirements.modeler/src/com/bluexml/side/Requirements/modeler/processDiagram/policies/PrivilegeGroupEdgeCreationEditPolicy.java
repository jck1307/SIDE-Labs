...
import com.bluexml.side.Requirements.modeler.processDiagram.commands.PrivilegeGroupEdgeCreationCommand;
import com.bluexml.side.requirements.PrivilegeGroup;

/**
 * PrivilegeGroup edge creation
 *
 * @generated
 */
public class PrivilegeGroupEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new PrivilegeGroupEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof PrivilegeGroup;
	}
	...
	protected boolean checkCommand(Command command) {
		return command instanceof PrivilegeGroupEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Goal
			...
			return new SourceTargetData(false, false, SourceTargetData.SOURCE,
					"com.bluexml.side.requirements.Goal", "privilegeGroup",
					null, "entryPoint", "privilegeGroup", null, null, null);
		}
		return null;
	}
