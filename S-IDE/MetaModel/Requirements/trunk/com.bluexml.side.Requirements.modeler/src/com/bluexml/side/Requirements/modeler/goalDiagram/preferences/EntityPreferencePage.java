 ...
 * @generated
 */
public class EntityPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return ReqDiagramPreferenceConstants.ENTITY_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ReqDiagramPreferenceConstants.ENTITY_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ReqDiagramPreferenceConstants.ENTITY_DEFAULT_FOREGROUND_COLOR;
	}
