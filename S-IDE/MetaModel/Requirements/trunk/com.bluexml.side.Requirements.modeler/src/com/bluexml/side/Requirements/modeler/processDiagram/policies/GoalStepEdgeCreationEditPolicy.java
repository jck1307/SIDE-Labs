...
import com.bluexml.side.Requirements.modeler.processDiagram.commands.GoalStepEdgeCreationCommand;
import com.bluexml.side.requirements.GoalStep;

/**
 * GoalStep edge creation
 *
 * @generated
 */
public class GoalStepEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new GoalStepEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof GoalStep;
	}
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof com.bluexml.side.requirements.Goal) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Goal
	...
	protected boolean checkCommand(Command command) {
		return command instanceof GoalStepEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.requirements.Goal
			...
			return new SourceTargetData(false, false, SourceTargetData.SOURCE,
					"com.bluexml.side.requirements.Goal", "step", null,
					"nextGoals", "step", null, null, null);
		}
		return null;
	}
