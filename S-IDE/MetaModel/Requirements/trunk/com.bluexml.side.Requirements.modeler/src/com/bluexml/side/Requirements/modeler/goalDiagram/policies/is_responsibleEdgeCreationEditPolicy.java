...
import com.bluexml.side.Requirements.modeler.goalDiagram.commands.is_responsibleEdgeCreationCommand;
...
public class is_responsibleEdgeCreationEditPolicy extends
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return ReqSimpleObjectConstants.SIMPLE_OBJECT_IS_RESPONSIBLE
