...
/**
 * A preference page to configure all preferences of the Requirements editor.
 *
 * @generated
 */
public class RequirementsPreferencePage extends AbstractTopcasedPreferencePage {
	/**
	 * @generated
	 */
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP)
				.setText("Requirements editor preference page");
	}
