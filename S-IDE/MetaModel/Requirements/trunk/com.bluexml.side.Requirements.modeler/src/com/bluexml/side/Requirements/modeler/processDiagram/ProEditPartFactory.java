 ...
 * @generated
 */
public class ProEditPartFactory extends ModelerEditPartFactory {
	/**
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof Diagram) {
			return new ProDiagramEditPart((Diagram) model);
			...
			if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
				// Manage the Element that are not associated with a model object
				if (ProSimpleObjectConstants.SIMPLE_OBJECT_IS_RESPONSIBLE
						.equals(((SimpleSemanticModelElement) edge
								.getSemanticModel()).getTypeInfo())) {
					return new is_responsibleEditPart(edge);
				}
				if (ProSimpleObjectConstants.SIMPLE_OBJECT_IS_SUB_GOAL
						.equals(((SimpleSemanticModelElement) edge
								.getSemanticModel()).getTypeInfo())) {
	...
	private class EdgeRequirementsSwitch extends RequirementsSwitch {
		...
		public Object caseGoalStep(com.bluexml.side.requirements.GoalStep object) {
			return new GoalStepEditPart(edge);
		}
