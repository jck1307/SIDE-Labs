...
public class PrivilegeGroupPreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return ProDiagramPreferenceConstants.PRIVILEGEGROUP_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ProDiagramPreferenceConstants.PRIVILEGEGROUP_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ProDiagramPreferenceConstants.PRIVILEGEGROUP_EDGE_DEFAULT_ROUTER;
	}
