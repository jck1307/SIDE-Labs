...
public class EntityPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ProDiagramPreferenceConstants.ENTITY_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProDiagramPreferenceConstants.ENTITY_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProDiagramPreferenceConstants.ENTITY_DEFAULT_FOREGROUND_COLOR;
	}
