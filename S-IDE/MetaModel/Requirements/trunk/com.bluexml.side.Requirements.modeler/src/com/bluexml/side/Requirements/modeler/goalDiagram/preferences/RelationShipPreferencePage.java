 ...
 * @generated
 */
public class RelationShipPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return ReqDiagramPreferenceConstants.RELATIONSHIP_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return ReqDiagramPreferenceConstants.RELATIONSHIP_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return ReqDiagramPreferenceConstants.RELATIONSHIP_EDGE_DEFAULT_ROUTER;
	}
