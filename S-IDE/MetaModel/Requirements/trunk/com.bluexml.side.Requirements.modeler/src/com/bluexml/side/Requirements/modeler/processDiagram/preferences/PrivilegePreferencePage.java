...
public class PrivilegePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return ProDiagramPreferenceConstants.PRIVILEGE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return ProDiagramPreferenceConstants.PRIVILEGE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return ProDiagramPreferenceConstants.PRIVILEGE_DEFAULT_FOREGROUND_COLOR;
	}
