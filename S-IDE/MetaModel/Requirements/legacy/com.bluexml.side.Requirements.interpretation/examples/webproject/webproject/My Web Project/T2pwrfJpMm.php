<html>
	<head>
		<title>Changement des param</title>
	...
	<h2>Composant ERP</h2>
		...
		?>
				...
				<td><a href="edit_ComposantERP_T2pwrfJpMm.php?ComposantERP=1&idObject=<? echo $data['id_cVQ46PIOKe']; ?>">Edit</a></td>
			</tr>
		<?			
			}
			mysql_close();
