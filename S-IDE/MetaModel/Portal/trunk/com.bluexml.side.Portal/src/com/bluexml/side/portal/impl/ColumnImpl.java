...
public class ColumnImpl extends EObjectImpl implements Column {
	 ...
	 * @ordered
	 */
	protected static final widthUnit UNIT_EDEFAULT = widthUnit.PERCENT;
	...
	public void setWidth(int newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PortalPackage.COLUMN__WIDTH, oldWidth, width));
	}
	 ...
	 * @generated
	 */
	public void setUnit(widthUnit newUnit) {
		widthUnit oldUnit = unit;
		unit = newUnit == null ? UNIT_EDEFAULT : newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PortalPackage.COLUMN__UNIT, oldUnit, unit));
	}
