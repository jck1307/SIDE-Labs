...
import com.bluexml.side.Portal.modeler.diagram.commands.update.IsChildPageUpdateCommand;
import com.bluexml.side.Portal.modeler.diagram.dialogs.IsChildPageEditDialog;
import com.bluexml.side.Portal.modeler.diagram.figures.isChildPageFigure;
...
/**
 * isChildPage controller
 *
 * @generated
 */
public class isChildPageEditPart extends EMFGraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public isChildPageEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		isChildPageFigure connection = new isChildPageFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore().getString(PdDiagramPreferenceConstants.ISCHILDPAGE_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore().getString(PdDiagramPreferenceConstants.ISCHILDPAGE_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(PdDiagramPreferenceConstants.ISCHILDPAGE_EDGE_DEFAULT_FONT);
	...
	public void performRequest(Request request) {
		isChildPage isChildPage = (isChildPage) Utils.getElement(getGraphEdge());
		if (request.getType() == RequestConstants.REQ_OPEN) {
			IsChildPageEditDialog dlg = new IsChildPageEditDialog(isChildPage, PortalPlugin.getActiveWorkbenchShell());
			if (dlg.open() == Window.OK) {
				IsChildPageUpdateCommand command = new IsChildPageUpdateCommand(isChildPage, dlg.getData());
