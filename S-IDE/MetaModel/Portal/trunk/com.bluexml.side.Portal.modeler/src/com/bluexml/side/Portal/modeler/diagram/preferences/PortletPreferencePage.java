 ...
 * @generated
 */
public class PortletPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return PdDiagramPreferenceConstants.PORTLET_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return PdDiagramPreferenceConstants.PORTLET_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return PdDiagramPreferenceConstants.PORTLET_DEFAULT_FOREGROUND_COLOR;
	}
