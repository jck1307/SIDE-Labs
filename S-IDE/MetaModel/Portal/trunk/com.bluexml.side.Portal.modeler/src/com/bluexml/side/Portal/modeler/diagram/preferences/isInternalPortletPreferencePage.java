 ...
 * @generated
 */
public class isInternalPortletPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return PdDiagramPreferenceConstants.ISINTERNALPORTLET_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return PdDiagramPreferenceConstants.ISINTERNALPORTLET_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return PdDiagramPreferenceConstants.ISINTERNALPORTLET_EDGE_DEFAULT_ROUTER;
	}
