 ...
 * @generated
 */
public class InstanciatePortletTypePreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return PdDiagramPreferenceConstants.INSTANCIATEPORTLETTYPE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return PdDiagramPreferenceConstants.INSTANCIATEPORTLETTYPE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return PdDiagramPreferenceConstants.INSTANCIATEPORTLETTYPE_EDGE_DEFAULT_ROUTER;
	}
