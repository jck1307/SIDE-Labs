...
/**
 * A preference page to configure all preferences of the Portal editor.
 *
 * @generated
 */
public class PortalPreferencePage extends AbstractTopcasedPreferencePage {
	/**
	 * @generated
	 */
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Portal editor preference page");
	}
