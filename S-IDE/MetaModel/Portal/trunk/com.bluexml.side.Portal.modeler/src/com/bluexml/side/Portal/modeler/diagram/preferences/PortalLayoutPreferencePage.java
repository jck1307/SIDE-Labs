 ...
 * @generated
 */
public class PortalLayoutPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return PdDiagramPreferenceConstants.PORTALLAYOUT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return PdDiagramPreferenceConstants.PORTALLAYOUT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return PdDiagramPreferenceConstants.PORTALLAYOUT_DEFAULT_FOREGROUND_COLOR;
	}
