 ...
 * @generated
 */
public class PortletInternalPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return PdDiagramPreferenceConstants.PORTLETINTERNAL_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return PdDiagramPreferenceConstants.PORTLETINTERNAL_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return PdDiagramPreferenceConstants.PORTLETINTERNAL_DEFAULT_FOREGROUND_COLOR;
	}
