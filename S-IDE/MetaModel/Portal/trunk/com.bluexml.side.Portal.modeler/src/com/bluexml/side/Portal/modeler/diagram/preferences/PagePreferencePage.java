 ...
 * @generated
 */
public class PagePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return PdDiagramPreferenceConstants.PAGE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return PdDiagramPreferenceConstants.PAGE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return PdDiagramPreferenceConstants.PAGE_DEFAULT_FOREGROUND_COLOR;
	}
