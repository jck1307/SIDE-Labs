 ...
 * @generated
 */
public class PortletTypePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return PdDiagramPreferenceConstants.PORTLETTYPE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return PdDiagramPreferenceConstants.PORTLETTYPE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return PdDiagramPreferenceConstants.PORTLETTYPE_DEFAULT_FOREGROUND_COLOR;
	}
