...
import com.bluexml.side.Portal.modeler.diagram.commands.UseLayoutEdgeCreationCommand;

/**
 * UseLayout edge creation
 *
 * @generated
 */
public class UseLayoutEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy {
	/**
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain, GraphEdge edge, GraphElement source) {
		return new UseLayoutEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return PdSimpleObjectConstants.SIMPLE_OBJECT_USELAYOUT.equals(((SimpleSemanticModelElement) edge.getSemanticModel()).getTypeInfo());
		}
		return false;
	}
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof com.bluexml.side.portal.Page) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Page && targetObject instanceof com.bluexml.side.portal.PortalLayout) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof UseLayoutEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Page && targetObject instanceof com.bluexml.side.portal.PortalLayout) {
			return new SourceTargetData(false, false, SourceTargetData.NONE, null, null, null, null, null, "useLayout", null, null);
		}
		return null;
	}
