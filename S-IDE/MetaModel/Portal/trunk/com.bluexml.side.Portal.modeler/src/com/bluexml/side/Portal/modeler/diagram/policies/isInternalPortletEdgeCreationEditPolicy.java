...
import com.bluexml.side.Portal.modeler.diagram.commands.isInternalPortletEdgeCreationCommand;

/**
 * isInternalPortlet edge creation
 *
 * @generated
 */
public class isInternalPortletEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy {
	/**
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain, GraphEdge edge, GraphElement source) {
		return new isInternalPortletEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return PdSimpleObjectConstants.SIMPLE_OBJECT_ISINTERNALPORTLET.equals(((SimpleSemanticModelElement) edge.getSemanticModel()).getTypeInfo());
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Portlet && targetObject instanceof com.bluexml.side.portal.PortletInternal) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof isInternalPortletEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Portlet && targetObject instanceof com.bluexml.side.portal.PortletInternal) {
			return new SourceTargetData(false, false, SourceTargetData.NONE, null, null, null, null, null, "isPortletInternal", null, null);
		}
		return null;
	}
