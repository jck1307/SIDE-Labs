...
import com.bluexml.side.Portal.modeler.diagram.commands.HavePortletEdgeCreationCommand;
import com.bluexml.side.portal.HavePortlet;

/**
 * HavePortlet edge creation
 *
 * @generated
 */
public class HavePortletEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy {
	/**
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain, GraphEdge edge, GraphElement source) {
		return new HavePortletEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof HavePortlet;
	}
	...
	protected boolean checkTargetForSource(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Page && targetObject instanceof com.bluexml.side.portal.Portlet) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof HavePortletEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Page && targetObject instanceof com.bluexml.side.portal.Portlet) {
			return new SourceTargetData(false, false, SourceTargetData.SOURCE, "com.bluexml.side.portal.Page", "portlets", "associationPage", "associationPortlet", "portlets", null, null, null);
		}
		return null;
	}
