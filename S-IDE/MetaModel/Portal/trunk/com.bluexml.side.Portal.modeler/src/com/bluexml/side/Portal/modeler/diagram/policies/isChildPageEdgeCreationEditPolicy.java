...
import com.bluexml.side.Portal.modeler.diagram.commands.isChildPageEdgeCreationCommand;
import com.bluexml.side.portal.isChildPage;

/**
 * isChildPage edge creation
 *
 * @generated
 */
public class isChildPageEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy {
	/**
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain, GraphEdge edge, GraphElement source) {
		return new isChildPageEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		return Utils.getElement(edge) instanceof isChildPage;
	}
	...
	protected boolean checkTargetForSource(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Page && targetObject instanceof com.bluexml.side.portal.Page) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof isChildPageEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source, GraphElement target) {
		...
		if (sourceObject instanceof com.bluexml.side.portal.Page && targetObject instanceof com.bluexml.side.portal.Page) {
			return new SourceTargetData(false, false, SourceTargetData.SOURCE, "com.bluexml.side.portal.Page", "isChildPageOf", null, "isChildPageOf", "isChildPageOf", null, null, null);
		}
		return null;
	}
