...
import com.bluexml.side.Portal.modeler.diagram.figures.UseLayoutFigure;
import com.bluexml.side.Portal.modeler.diagram.preferences.PdDiagramPreferenceConstants;

/**
 * UseLayout controller
 *
 * @generated
 */
public class UseLayoutEditPart extends GraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public UseLayoutEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		UseLayoutFigure connection = new UseLayoutFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore().getString(PdDiagramPreferenceConstants.USELAYOUT_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore().getString(PdDiagramPreferenceConstants.USELAYOUT_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(PdDiagramPreferenceConstants.USELAYOUT_EDGE_DEFAULT_FONT);
