...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.portal.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GroupItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUsePagePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Use Page feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUsePagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_usePage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_usePage_feature", "_UI_Group_type"),
				 PortalPackage.Literals.GROUP__USE_PAGE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PortalPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
