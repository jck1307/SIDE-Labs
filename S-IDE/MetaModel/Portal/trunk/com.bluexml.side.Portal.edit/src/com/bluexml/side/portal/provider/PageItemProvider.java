...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.portal.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PortalPackage.Literals.PAGE__ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Use Layout feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUseLayoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_useLayout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_useLayout_feature", "_UI_Page_type"),
				 PortalPackage.Literals.PAGE__USE_LAYOUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_position_feature", "_UI_Page_type"),
				 PortalPackage.Literals.PAGE__POSITION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PortalPackage.Literals.PAGE__PORTLETS);
			childrenFeatures.add(PortalPackage.Literals.PAGE__IS_CHILD_PAGE_OF);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PortalPackage.Literals.PAGE__PORTLETS,
				 PortalFactory.eINSTANCE.createHavePortlet()));
