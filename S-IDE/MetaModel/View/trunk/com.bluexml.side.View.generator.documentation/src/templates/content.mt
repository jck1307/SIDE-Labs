...
<%script type="view.AbstractView" name="indexView"%>
	 ...
	 <text:p text:style-name="P6">
	  <text:a xlink:type="simple" xlink:href="#2.<%name%> Fields|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link"><%name%> Fields<text:tab/></text:a>
