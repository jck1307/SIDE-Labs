...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.workflow.WfPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WfPackageItemProvider
	 ...
	 * @generated
	 */
	public WfPackageItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WfPackage"));
	}
	...
	public String getText(Object object) {
		String label = ((WfPackage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WfPackage_type") :
			getString("_UI_WfPackage_type") + " " + label;
	}
