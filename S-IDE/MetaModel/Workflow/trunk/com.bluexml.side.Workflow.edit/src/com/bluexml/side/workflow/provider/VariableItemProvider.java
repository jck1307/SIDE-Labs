...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.workflow.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.VARIABLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAccessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variable_access_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variable_access_feature", "_UI_Variable_type"),
				 WorkflowPackage.Literals.VARIABLE__ACCESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
