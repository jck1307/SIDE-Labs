...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.workflow.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_javaClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_javaClass_feature", "_UI_Action_type"),
				 WorkflowPackage.Literals.ACTION__JAVA_CLASS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.ACTION__SCRIPT);
		}
