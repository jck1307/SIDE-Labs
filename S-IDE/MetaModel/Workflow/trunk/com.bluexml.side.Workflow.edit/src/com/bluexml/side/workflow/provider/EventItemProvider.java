...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.workflow.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.EVENT__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowPackage.Literals.EVENT__ACTION);
		}
	...
	public String getText(Object object) {
		BPMEventType labelValue = ((Event)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Event.class)) {
			case WorkflowPackage.EVENT__TYPE:
