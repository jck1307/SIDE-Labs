...
public class ScriptImpl extends EObjectImpl implements Script {
	...
	public EList<Variable> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<Variable>(Variable.class, this, WorkflowPackage.SCRIPT__VARIABLE);
		}
		return variable;
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowPackage.SCRIPT__EXPRESSION, oldExpression, expression));
	}
