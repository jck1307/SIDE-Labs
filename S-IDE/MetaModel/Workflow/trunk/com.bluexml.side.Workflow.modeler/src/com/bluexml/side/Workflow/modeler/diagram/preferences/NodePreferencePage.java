 ...
 * @generated
 */
public class NodePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return WfDiagramPreferenceConstants.NODE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return WfDiagramPreferenceConstants.NODE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return WfDiagramPreferenceConstants.NODE_DEFAULT_FOREGROUND_COLOR;
	}
