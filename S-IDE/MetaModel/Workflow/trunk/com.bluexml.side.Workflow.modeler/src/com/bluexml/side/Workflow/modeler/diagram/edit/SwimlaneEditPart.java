...
/**
 * The Swimlane object controller
 *
 * @generated
 */
public class SwimlaneEditPart extends EMFGraphNodeEditPart {
	/**
	 * Constructor
	 *
	 ...
	 * @generated
	 */
	public SwimlaneEditPart(GraphNode obj) {
		super(obj);
	}
		...
		installEditPolicy(ModelerEditPolicyConstants.RESTORE_EDITPOLICY,
				new RestoreEditPolicy() {
					protected Command getRestoreConnectionsCommand(
						...
						return new SwimlaneRestoreConnectionCommand(getHost());
					}
				});
