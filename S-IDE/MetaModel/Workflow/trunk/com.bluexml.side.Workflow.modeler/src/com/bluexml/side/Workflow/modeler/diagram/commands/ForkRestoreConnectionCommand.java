...
/**
 * Fork restore connection command
 *
 * @generated
 */
public class ForkRestoreConnectionCommand extends
		AbstractRestoreConnectionCommand {
	/**
	 * @param part the EditPart that is restored
	 * @generated
	 */
	public ForkRestoreConnectionCommand(EditPart part) {
		super(part);
	}
			...
			for (GraphElement graphElementTgt : getAllGraphElements()) {
				...
				if (eObjectTgt instanceof TaskNode) {
					if (autoRef) {
						...
						// if graphElementSrc is the target of the edge or if it is the source and that the SourceTargetCouple is reversible
						createTransitionFromTaskNodeToFork_To(graphElementTgt,
								graphElementSrc);
					}
				}
				...
				if (eObjectTgt instanceof Decision) {
					if (autoRef) {
						...
						// if graphElementSrc is the target of the edge or if it is the source and that the SourceTargetCouple is reversible
						createTransitionFromDecisionToFork_To(graphElementTgt,
								graphElementSrc);
					}
				}
				...
				if (eObjectTgt instanceof Decision) {
					if (autoRef) {
						...
						createTransitionFromForkToDecision_To(graphElementSrc,
								graphElementTgt);
					}
				}
				...
				if (eObjectTgt instanceof Fork) {
					if (autoRef) {
						...
						// if the graphElementSrc is the source of the edge or if it is the target and that the SourceTargetCouple is reversible
						createTransitionFromForkToFork_To(graphElementSrc,
								graphElementTgt);
						// if graphElementSrc is the target of the edge or if it is the source and that the SourceTargetCouple is reversible
						createTransitionFromForkToFork_To(graphElementTgt,
								graphElementSrc);
					}
				}
				...
				if (eObjectTgt instanceof Join) {
					if (autoRef) {
						...
						// if the graphElementSrc is the source of the edge or if it is the target and that the SourceTargetCouple is reversible
						createTransitionFromForkToJoin_To(graphElementSrc,
								graphElementTgt);
					}
				}
				...
				if (eObjectTgt instanceof TaskNode) {
					if (autoRef) {
						...
						// if the graphElementSrc is the source of the edge or if it is the target and that the SourceTargetCouple is reversible
						createTransitionFromForkToTaskNode_To(graphElementSrc,
								graphElementTgt);
					}
				}
				...
				if (eObjectTgt instanceof Node) {
					if (autoRef) {
						...
						// if the graphElementSrc is the source of the edge or if it is the target and that the SourceTargetCouple is reversible
						createTransitionFromForkToNode_To(graphElementSrc,
								graphElementTgt);
					}
				}
				...
				if (eObjectTgt instanceof EndState) {
					if (autoRef) {
						...
						// if the graphElementSrc is the source of the edge or if it is the target and that the SourceTargetCouple is reversible
						createTransitionFromForkToEndState_To(graphElementSrc,
								graphElementTgt);
					}
				}
				...
				if (eObjectTgt instanceof Join) {
					if (autoRef) {
						...
						// if graphElementSrc is the target of the edge or if it is the source and that the SourceTargetCouple is reversible
						createTransitionFromJoinToFork_To(graphElementTgt,
								graphElementSrc);
					}
				}
	 ...
	 * @generated
	 */
	private void createTransitionFromForkToFork_To(GraphElement srcElt,
			GraphElement targetElt) {
		Fork sourceObject = (Fork) Utils.getElement(srcElt);
		Fork targetObject = (Fork) Utils.getElement(targetElt);
