 ...
 * @generated
 */
public class TransitionPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return WfDiagramPreferenceConstants.TRANSITION_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return WfDiagramPreferenceConstants.TRANSITION_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return WfDiagramPreferenceConstants.TRANSITION_EDGE_DEFAULT_ROUTER;
	}
