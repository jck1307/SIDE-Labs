 ...
 * @generated
 */
public class DecisionPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return WfDiagramPreferenceConstants.DECISION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return WfDiagramPreferenceConstants.DECISION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return WfDiagramPreferenceConstants.DECISION_DEFAULT_FOREGROUND_COLOR;
	}
