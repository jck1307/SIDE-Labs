 ...
 * @generated
 */
public class isAssociatedWithPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return WfDiagramPreferenceConstants.ISASSOCIATEDWITH_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return WfDiagramPreferenceConstants.ISASSOCIATEDWITH_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return WfDiagramPreferenceConstants.ISASSOCIATEDWITH_EDGE_DEFAULT_ROUTER;
	}
