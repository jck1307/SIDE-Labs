...
import com.bluexml.side.Workflow.modeler.diagram.commands.ForkRestoreConnectionCommand;
import com.bluexml.side.Workflow.modeler.diagram.figures.ForkFigure;
...
/**
 * The Fork object controller
 *
 * @generated
 */
public class ForkEditPart extends EMFGraphNodeEditPart {
	/**
	 * Constructor
	 *
	 ...
	 * @generated
	 */
	public ForkEditPart(GraphNode obj) {
		super(obj);
	}
		...
		installEditPolicy(ModelerEditPolicyConstants.RESTORE_EDITPOLICY,
				new RestoreEditPolicy() {
					protected Command getRestoreConnectionsCommand(
						...
						return new ForkRestoreConnectionCommand(getHost());
					}
				});
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(
				WfDiagramPreferenceConstants.FORK_DEFAULT_FONT);
