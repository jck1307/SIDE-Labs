 ...
 * @generated
 */
public class ActionPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return WfDiagramPreferenceConstants.ACTION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return WfDiagramPreferenceConstants.ACTION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return WfDiagramPreferenceConstants.ACTION_DEFAULT_FOREGROUND_COLOR;
	}
