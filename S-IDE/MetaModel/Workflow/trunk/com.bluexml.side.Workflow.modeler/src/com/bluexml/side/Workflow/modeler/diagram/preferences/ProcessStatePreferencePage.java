 ...
 * @generated
 */
public class ProcessStatePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return WfDiagramPreferenceConstants.PROCESSSTATE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return WfDiagramPreferenceConstants.PROCESSSTATE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return WfDiagramPreferenceConstants.PROCESSSTATE_DEFAULT_FOREGROUND_COLOR;
	}
