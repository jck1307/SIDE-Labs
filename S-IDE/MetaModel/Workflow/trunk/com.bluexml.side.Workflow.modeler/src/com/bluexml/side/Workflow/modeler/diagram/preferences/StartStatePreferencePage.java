 ...
 * @generated
 */
public class StartStatePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return WfDiagramPreferenceConstants.STARTSTATE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return WfDiagramPreferenceConstants.STARTSTATE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return WfDiagramPreferenceConstants.STARTSTATE_DEFAULT_FOREGROUND_COLOR;
	}
