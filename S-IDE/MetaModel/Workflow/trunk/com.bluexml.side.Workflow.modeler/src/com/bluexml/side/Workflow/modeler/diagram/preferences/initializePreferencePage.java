 ...
 * @generated
 */
public class initializePreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return WfDiagramPreferenceConstants.INITIALIZE_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return WfDiagramPreferenceConstants.INITIALIZE_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return WfDiagramPreferenceConstants.INITIALIZE_EDGE_DEFAULT_ROUTER;
	}
