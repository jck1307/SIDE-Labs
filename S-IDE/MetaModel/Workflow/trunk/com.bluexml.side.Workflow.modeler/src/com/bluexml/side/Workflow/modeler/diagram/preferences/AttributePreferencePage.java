...
public class AttributePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return WfDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return WfDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return WfDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_FOREGROUND_COLOR;
	}
