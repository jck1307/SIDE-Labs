...
import com.bluexml.side.Workflow.modeler.diagram.commands.hasTimerEdgeCreationCommand;

/**
 * hasTimer edge creation
 *
 * @generated
 */
public class hasTimerEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new hasTimerEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return WfSimpleObjectConstants.SIMPLE_OBJECT_HASTIMER
	...
	protected boolean checkSource(GraphElement source) {
		...
		if (object instanceof com.bluexml.side.workflow.Transition) {
			return true;
		}
		return false;
	}
	...
	protected boolean checkTargetForSource(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.workflow.Transition
				&& targetObject instanceof com.bluexml.side.workflow.Timer) {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof hasTimerEdgeCreationCommand;
	}
	...
	protected SourceTargetData getSourceTargetData(GraphElement source,
		...
		if (sourceObject instanceof com.bluexml.side.workflow.Transition
			...
			return new SourceTargetData(false, false, SourceTargetData.NONE,
					null, null, null, null, null, "timer", null, null);
		}
		return null;
	}
