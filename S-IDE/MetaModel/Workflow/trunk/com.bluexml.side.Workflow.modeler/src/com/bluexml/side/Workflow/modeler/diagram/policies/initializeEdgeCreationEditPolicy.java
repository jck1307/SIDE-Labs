...
import com.bluexml.side.Workflow.modeler.diagram.commands.initializeEdgeCreationCommand;
 ...
 * @generated
 */
public class initializeEdgeCreationEditPolicy extends
	...
	protected CreateTypedEdgeCommand createCommand(EditDomain domain,
		...
		return new initializeEdgeCreationCommand(domain, edge, source);
	}
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return WfSimpleObjectConstants.SIMPLE_OBJECT_INITIALIZE
	...
	protected boolean checkCommand(Command command) {
		return command instanceof initializeEdgeCreationCommand;
	}
