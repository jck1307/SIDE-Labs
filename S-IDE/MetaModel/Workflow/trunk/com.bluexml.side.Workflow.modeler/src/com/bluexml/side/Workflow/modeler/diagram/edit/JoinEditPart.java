...
import com.bluexml.side.Workflow.modeler.diagram.commands.JoinRestoreConnectionCommand;
import com.bluexml.side.Workflow.modeler.diagram.figures.JoinFigure;
...
/**
 * The Join object controller
 *
 * @generated
 */
public class JoinEditPart extends EMFGraphNodeEditPart {
	/**
	 * Constructor
	 *
	 ...
	 * @generated
	 */
	public JoinEditPart(GraphNode obj) {
		super(obj);
	}
		...
		installEditPolicy(ModelerEditPolicyConstants.RESTORE_EDITPOLICY,
				new RestoreEditPolicy() {
					protected Command getRestoreConnectionsCommand(
						...
						return new JoinRestoreConnectionCommand(getHost());
					}
				});
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(
				WfDiagramPreferenceConstants.JOIN_DEFAULT_FONT);
