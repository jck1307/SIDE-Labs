		...
		newChildDescriptors.add
			(createChildParameter
				(ClazzPackage.Literals.CLASS_PACKAGE__ASSOCIATION_SET,
				 ClazzFactory.eINSTANCE.createAssociation()));

		newChildDescriptors.add
			(createChildParameter
				(ClazzPackage.Literals.CLASS_PACKAGE__ASPECT_SET,
				 ClazzFactory.eINSTANCE.createAspect()));

		newChildDescriptors.add
			(createChildParameter
				(ClazzPackage.Literals.CLASS_PACKAGE__ENUMERATION_SET,
				 ClazzFactory.eINSTANCE.createEnumeration()));
