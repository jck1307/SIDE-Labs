...
/**
 * This is the item provider adapter for a {@link com.bluexml.side.clazz.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_typ_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_typ_feature", "_UI_Attribute_type"),
				 ClazzPackage.Literals.ATTRIBUTE__TYP,
				 true,
				 false,
				 false,
	...
	protected void addInitialValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_initialValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_initialValue_feature", "_UI_Attribute_type"),
				 ClazzPackage.Literals.ATTRIBUTE__INITIAL_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClazzPackage.Literals.ATTRIBUTE__VALUE_LIST,
				 true,
				 false,
				 true,
				 null,
