...
public class EnumerationLiteralPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.ENUMERATIONLITERAL_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.ENUMERATIONLITERAL_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.ENUMERATIONLITERAL_DEFAULT_FOREGROUND_COLOR;
	}
