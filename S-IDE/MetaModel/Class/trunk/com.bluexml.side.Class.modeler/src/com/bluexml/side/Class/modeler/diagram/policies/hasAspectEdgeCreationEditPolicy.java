 ...
 * @generated
 */
public class hasAspectEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy {
	/**
	...
	protected boolean checkEdge(GraphEdge edge) {
		if (edge.getSemanticModel() instanceof SimpleSemanticModelElement) {
			return CdSimpleObjectConstants.SIMPLE_OBJECT_HASASPECT.equals(((SimpleSemanticModelElement) edge.getSemanticModel()).getTypeInfo());
		}
		return false;
	}
