...
public class GeneralizationPreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return CdDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return CdDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return CdDiagramPreferenceConstants.GENERALIZATION_EDGE_DEFAULT_ROUTER;
	}
