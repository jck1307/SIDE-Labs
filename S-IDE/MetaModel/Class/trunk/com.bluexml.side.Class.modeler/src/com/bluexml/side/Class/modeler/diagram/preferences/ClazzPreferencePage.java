...
public class ClazzPreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.CLAZZ_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.CLAZZ_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.CLAZZ_DEFAULT_FOREGROUND_COLOR;
	}
