...
/**
 * A preference page to configure all preferences of the Clazz editor.
 *
 * @generated
 */
public class ClazzPreferencePage extends AbstractTopcasedPreferencePage {
	/**
	 * @generated
	 */
	...
	private void createHeader(Composite parent) {
		new Label(parent, SWT.WRAP).setText("Clazz editor preference page");
	}
