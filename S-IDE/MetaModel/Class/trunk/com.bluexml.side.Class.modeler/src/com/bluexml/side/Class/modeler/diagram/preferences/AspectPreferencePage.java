 ...
 * @generated
 */
public class AspectPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.ASPECT_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.ASPECT_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.ASPECT_DEFAULT_FOREGROUND_COLOR;
	}
