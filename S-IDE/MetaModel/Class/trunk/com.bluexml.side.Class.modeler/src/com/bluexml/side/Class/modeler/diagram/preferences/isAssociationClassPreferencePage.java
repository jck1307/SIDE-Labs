...
public class isAssociationClassPreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return CdDiagramPreferenceConstants.ISASSOCIATIONCLASS_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return CdDiagramPreferenceConstants.ISASSOCIATIONCLASS_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return CdDiagramPreferenceConstants.ISASSOCIATIONCLASS_EDGE_DEFAULT_ROUTER;
	}
