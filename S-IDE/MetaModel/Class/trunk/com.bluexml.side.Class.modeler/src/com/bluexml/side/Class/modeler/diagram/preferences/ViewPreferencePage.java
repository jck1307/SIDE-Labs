 ...
 * @generated
 */
public class ViewPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.VIEW_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.VIEW_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.VIEW_DEFAULT_FOREGROUND_COLOR;
	}
