...
public class isStereotypedEditPart extends GraphEdgeEditPart {
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore().getString(CdDiagramPreferenceConstants.ISSTEREOTYPED_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore().getString(CdDiagramPreferenceConstants.ISSTEREOTYPED_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(CdDiagramPreferenceConstants.ISSTEREOTYPED_EDGE_DEFAULT_FONT);
