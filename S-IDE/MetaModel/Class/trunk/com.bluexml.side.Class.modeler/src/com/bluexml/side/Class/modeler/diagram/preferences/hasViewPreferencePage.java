 ...
 * @generated
 */
public class hasViewPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return CdDiagramPreferenceConstants.HASVIEW_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return CdDiagramPreferenceConstants.HASVIEW_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return CdDiagramPreferenceConstants.HASVIEW_EDGE_DEFAULT_ROUTER;
	}
