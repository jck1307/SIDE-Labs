 ...
 * @generated
 */
public class dependsPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return CdDiagramPreferenceConstants.DEPENDS_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return CdDiagramPreferenceConstants.DEPENDS_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return CdDiagramPreferenceConstants.DEPENDS_EDGE_DEFAULT_ROUTER;
	}
