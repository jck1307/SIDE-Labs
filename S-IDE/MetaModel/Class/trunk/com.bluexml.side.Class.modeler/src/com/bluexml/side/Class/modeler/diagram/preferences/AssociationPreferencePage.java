...
public class AssociationPreferencePage extends AbstractEdgePreferencePage {
	...
	protected String getEdgeFont() {
		return CdDiagramPreferenceConstants.ASSOCIATION_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return CdDiagramPreferenceConstants.ASSOCIATION_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return CdDiagramPreferenceConstants.ASSOCIATION_EDGE_DEFAULT_ROUTER;
	}
