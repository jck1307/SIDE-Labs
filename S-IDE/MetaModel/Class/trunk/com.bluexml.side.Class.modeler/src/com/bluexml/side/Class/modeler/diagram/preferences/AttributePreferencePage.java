...
public class AttributePreferencePage extends AbstractNodePreferencePage {
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.ATTRIBUTE_DEFAULT_FOREGROUND_COLOR;
	}
