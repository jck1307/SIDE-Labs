...
import com.bluexml.side.Class.modeler.diagram.figures.isAssociationClassFigure;
import com.bluexml.side.Class.modeler.diagram.preferences.CdDiagramPreferenceConstants;

/**
 * isAssociationClass controller
 *
 * @generated
 */
public class isAssociationClassEditPart extends GraphEdgeEditPart {
	 ...
	 * @generated
	 */
	public isAssociationClassEditPart(GraphEdge model) {
		super(model);
	}
	...
	protected IFigure createFigure() {
		isAssociationClassFigure connection = new isAssociationClassFigure();
	...
	protected String getPreferenceDefaultRouter() {
		return getPreferenceStore().getString(CdDiagramPreferenceConstants.ISASSOCIATIONCLASS_EDGE_DEFAULT_ROUTER);
	}
	...
	protected Color getPreferenceDefaultForegroundColor() {
		String preferenceForeground = getPreferenceStore().getString(CdDiagramPreferenceConstants.ISASSOCIATIONCLASS_EDGE_DEFAULT_FOREGROUND_COLOR);
	...
	protected Font getPreferenceDefaultFont() {
		String preferenceFont = getPreferenceStore().getString(CdDiagramPreferenceConstants.ISASSOCIATIONCLASS_EDGE_DEFAULT_FONT);
