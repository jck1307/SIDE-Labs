...
import com.bluexml.side.Class.modeler.diagram.commands.isCommentedEdgeCreationCommand;

/**
 * isCommented edge creation
 *
 * @generated
 */
public class isCommentedEdgeCreationEditPolicy extends AbstractEdgeCreationEditPolicy {
	...
	protected boolean checkCommand(Command command) {
		return command instanceof isCommentedEdgeCreationCommand;
	}
