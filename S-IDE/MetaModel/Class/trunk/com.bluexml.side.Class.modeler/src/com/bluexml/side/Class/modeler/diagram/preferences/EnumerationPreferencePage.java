 ...
 * @generated
 */
public class EnumerationPreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.ENUMERATION_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.ENUMERATION_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.ENUMERATION_DEFAULT_FOREGROUND_COLOR;
	}
