 ...
 * @generated
 */
public class StereotypePreferencePage extends AbstractNodePreferencePage {
	/**
	...
	protected String getNodeBackgroundColor() {
		return CdDiagramPreferenceConstants.STEREOTYPE_DEFAULT_BACKGROUND_COLOR;
	}
	...
	protected String getNodeFont() {
		return CdDiagramPreferenceConstants.STEREOTYPE_DEFAULT_FONT;
	}
	...
	protected String getNodeForegroundColor() {
		return CdDiagramPreferenceConstants.STEREOTYPE_DEFAULT_FOREGROUND_COLOR;
	}
