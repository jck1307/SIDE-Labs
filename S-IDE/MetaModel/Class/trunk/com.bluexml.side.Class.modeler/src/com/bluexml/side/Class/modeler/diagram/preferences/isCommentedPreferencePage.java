 ...
 * @generated
 */
public class isCommentedPreferencePage extends AbstractEdgePreferencePage {
	/**
	 * @see org.topcased.modeler.preferences.AbstractEdgePreferencePage#getEdgeFont()
	 * @generated
	 */
	protected String getEdgeFont() {
		return CdDiagramPreferenceConstants.ISCOMMENTED_EDGE_DEFAULT_FONT;
	}
	...
	protected String getEdgeForegroundColor() {
		return CdDiagramPreferenceConstants.ISCOMMENTED_EDGE_DEFAULT_FOREGROUND_COLOR;
	}
	...
	protected String getEdgeRouter() {
		return CdDiagramPreferenceConstants.ISCOMMENTED_EDGE_DEFAULT_ROUTER;
	}
