...
<%if (eContainer() == null) {%><%getProperty("alf.paths.extension.client.webscripts")%>/org/alfresco/slingshot/documentlibrary/doclist.get.js<%}%>
<%script type="clazz.ClassPackage" name="doclist_get_js" file="<%validatedFilename%>"%>
