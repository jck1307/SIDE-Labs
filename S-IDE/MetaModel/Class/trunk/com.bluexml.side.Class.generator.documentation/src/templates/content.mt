...
<text:a xlink:type="simple" xlink:href="#1.<%getLabel()%>|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link"><%getLabel()%><text:tab/></text:a>
<text:a xlink:type="simple" xlink:href="#1.<%getLabel()%>|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link">1</text:a>
</text:p>
<text:p text:style-name="P6">
<text:a xlink:type="simple" xlink:href="#2.<%getLabel()%> attributes|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link"><%getLabel()%> attributes<text:tab/></text:a>
<text:a xlink:type="simple" xlink:href="#2.<%getLabel()%> attributes|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link">1</text:a>
</text:p>
<text:p text:style-name="P6">
<text:a xlink:type="simple" xlink:href="#2.<%getLabel()%> associations|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link"><%getLabel()%> associations<text:tab/></text:a>
<text:a xlink:type="simple" xlink:href="#2.<%getLabel()%> associations|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link">1</text:a>
</text:p>
	<%}%>
	<%if (getDiagImgPath.length > 0){%>
<text:p text:style-name="P5">
<text:a xlink:type="simple" xlink:href="#1.<%getDocumentationOrName()%>|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link">Diagrams<text:tab/></text:a>
<text:a xlink:type="simple" xlink:href="#1.<%getDocumentationOrName()%>|outline" text:style-name="Internet_20_link" text:visited-style-name="Internet_20_link">1</text:a>
</text:p>
    	<%for (getDiagImgPath) {%>
<text:p text:style-name="P6">
