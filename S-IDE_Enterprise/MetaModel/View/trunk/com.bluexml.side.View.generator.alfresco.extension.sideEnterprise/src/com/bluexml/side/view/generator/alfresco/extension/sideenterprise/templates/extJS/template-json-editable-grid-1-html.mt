...
<%if (eContainer() == getRootContainer()){%><%getProperty("extJSProject")%>/library/<%name%>/extJs/json-editable-grid-1.html<%}%>
...
<head>
    ...
    <!-- page specific -->
    <script type="text/javascript" src="./library/<%name%>/extJs/json-editable-grid-1.js"></script>

</head>
<body>
    <div id="<%name%>_grid-example-json-1"></div>
</body>
</html>
