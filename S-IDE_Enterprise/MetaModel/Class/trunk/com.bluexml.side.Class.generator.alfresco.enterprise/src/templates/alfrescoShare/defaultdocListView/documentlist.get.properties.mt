...
actions.description.workingCopyOwner=Locked for editing by you
...
actions.document.view=View In Browser
actions.document.locate=Locate File
...
actions.document.inline-edit=Inline Edit
...
actions.document.view-original=View Original Document
actions.document.view-working-copy=View Working Copy
actions.link.delete=Delete Link
actions.folder.edit-metadata=Edit Metadata
actions.folder.view-metadata=View Details
actions.folder.locate=Locate Folder
...
actions.folder.explorer-view=View in Alfresco Explorer
actions.more=More...
