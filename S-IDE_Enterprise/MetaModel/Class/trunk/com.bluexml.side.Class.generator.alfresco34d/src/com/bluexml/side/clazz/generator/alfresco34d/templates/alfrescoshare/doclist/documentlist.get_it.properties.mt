...
details.created.on=Creato il:
details.created.by=Creato da:
details.modified.on=Modificato il:
details.modified.by=Modificato da:
details.editing-started.on=Modifica iniziata il:
...
message.simple-workflow.failure=Impossibile completare l'azione del workflow.
