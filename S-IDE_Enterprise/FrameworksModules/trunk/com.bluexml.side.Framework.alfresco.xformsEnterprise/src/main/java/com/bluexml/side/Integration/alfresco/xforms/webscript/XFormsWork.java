...
public class XFormsWork implements RunAsWork<String> {
	 ...
	 */
	private String resolveObjectInfo(String datatype, String identifier, String format, String labelLength, String idValue) {
	 ...
	 */
	private void addSearchableAttributes(Map<QName, PropertyDefinition> typeProperties, Map<QName, PropertyDefinition> properties) {
	...
	private SearchParameters createSearchParameters(String type, List<String> searchedValues, int maxResults) {
