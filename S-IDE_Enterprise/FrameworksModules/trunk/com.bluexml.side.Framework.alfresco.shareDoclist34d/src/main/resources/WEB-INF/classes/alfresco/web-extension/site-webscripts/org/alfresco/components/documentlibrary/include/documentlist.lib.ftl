...
<div id="${args.htmlid}-body" class="doclist">
   <div id="${args.htmlid}-doclistBar" class="yui-gc doclist-bar flat-button">
      ...
      <div class="yui-u align-right">         
        <button id="${args.htmlid}-sort-button" name="doclist-sort-button">${msg("label.sortby")}</button>
      	<div id="${args.htmlid}-sort-menu" class="yuimenu">
            <div class="bd">
              <ul>
                 <#list sortFields as sort>
                 <li><span><span class="sort-${sort.key}">${msg(sort.label)}</span></span></li>
                 </#list>
              </ul>
            </div>
         </div>
