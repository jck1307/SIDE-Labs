   ...
   YAHOO.lang.augmentObject(Alfresco.DocumentList.prototype,
   {
      ...
      _setupDataSource: function DL__setupDataSource()
      {
         ...
         this.widgets.dataSource.responseSchema =
         {
            ...
            [
               ...
               "version", "size", "contentUrl", "actionSet", "tags", "customProperties", "categories", "activeWorkflows", "isFavourite", "location", "permissions", "custom",
               "onlineEditUrl"
            ],
            metaFields:
            {
      ...
      _setupDataTable: function DL__setupDataTable()
      {
         ...
         [
            ...
            { key: "actions", label: "Actions", sortable: false, formatter: this.fnRenderCellActions(), width: 180 }
         ];
