...
<%
	...
	System.out.println("processRequest loaded :"+new Helper().serializeFMap(selection));
...
<jsp:include page="renderSelection.jsp" flush="true">
  ...
  <jsp:param name="browsePage" value="browseSimple_content.jsp?" />
</jsp:include>
<%
...
<%
    if (bodyTransformer == null || selectionHtmlDomResult == null) {
        ...
        bodyTransformer.transform(new DOMSource(selectionHtmlDomResult.getNode()), new StreamResult(out));
    }
%>
<body>
</html>