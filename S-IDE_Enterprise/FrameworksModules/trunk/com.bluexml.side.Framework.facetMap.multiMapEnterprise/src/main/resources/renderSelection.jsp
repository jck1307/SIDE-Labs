...
<%
    try {
        ...
        System.out.println("Type = "+request.getParameter("facetName"));
        transformer.setParameter("server", request.getProtocol()+request.getRemoteHost()+":"+request.getRemotePort());
        transformer.setParameter("facetName", "&facetName="+request.getParameter("facetName"));
        transformer.setParameter("isAdmin", request.getSession().getAttribute("isAdmin"));
        transformer.setParameter("community", "&community="+request.getParameter("community"));
